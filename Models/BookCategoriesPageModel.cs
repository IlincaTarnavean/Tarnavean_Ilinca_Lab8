...
namespace Tarnavean_Ilinca_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Tarnavean_Ilinca_Lab8Context context,
                                                    Book book)
        {
        ...
        public void UpdateBookCategories(Tarnavean_Ilinca_Lab8Context context,
